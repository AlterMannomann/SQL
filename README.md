...
- **Volumes** Structures that keep nodes together.
...
## Processing volumes
Example of processing volumes. Had to integrate a bigger GIF with less quality as the better and smaller MP4 file seems not to work on Github.
