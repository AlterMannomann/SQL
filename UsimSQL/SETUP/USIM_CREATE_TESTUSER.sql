...
GRANT ALL ON usim_run_sql_test TO usim_test;
GRANT ALL ON usim_run_server_sql_test TO usim_test;
GRANT ALL ON usim_run_recreate TO usim_test;
GRANT ALL ON usim_run_script TO usim_test;
GRANT ALL ON usim_run_test TO usim_test;
GRANT ALL ON usim_run_testdata TO usim_test;
GRANT ALL ON usim_install_state TO usim_test;
GRANT ALL ON usim_load_log TO usim_test;
