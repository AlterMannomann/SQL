...
COMMENT ON COLUMN usim_spc_process.usim_id_spr IS 'The unique id of a process step. Will be set on insert.';
...
COMMENT ON COLUMN usim_spc_process.is_processed IS 'The indicator for processed outputs. On creation 0, after output applied 1, if universe of target not valid 2. Only updates allowed. Any update sets this to 1 (processed).';
